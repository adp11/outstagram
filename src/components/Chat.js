    ...
    <ChatContext.Provider value={providerValue}>
      <div className={`Chat ${(isSearchChatActive) ? "blur opac" : (isFullImageActive) ? "blur2 opac2" : ""}`} style={{ position: (isSearchChatActive || isFullImageActive) && "fixed" }}>
        <div className="chat-container">
          ...
          <div className="active-chats-list">
            {activeRoomList.map((room) => (
              ...
              <div onClick={() => { handleViewFullRoom(room); }} className="active-chat" style={{backgroundColor: (whichRoomActive && (room.roomId === whichRoomActive.roomId)) ? "#efefef" : ""}} key={room.roomId}>
                <img
          ...
          {(params.roomId && whichRoomActive) ? (
            <div className="full-chat-header">
              ...
              <div className="more">
                <svg onClick={() => { setIsDropdownActive(!isDropdownActive); }} aria-label="View Thread Details" className="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
        ...
        {(params.roomId && whichRoomActive) ? (
              ...
              {(whichRoomActive && texts[whichRoomActive.roomId] && texts[whichRoomActive.roomId].trim()) ? (
                ...
                <div style={{ display: "flex", gap: "10px", width: "60px" }}>
                  ...
                  <label htmlFor="file-upload" style={{ width: "24px", height: "24px", position: "relative" }}>
                    ...
                    />
                    <svg className="send-image" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24" style={{ position: "absolute", left: "0" }}>
                  ...
                  <svg onClick={(e) => { handleSubmitMessage(e, true); }} className="drop-heart" color="#262626" fill="#262626" height="24" width="24">
          ...
          >
            <svg aria-label="Direct" className="_ab6-" color="#262626" fill="#262626" height="96" role="img" viewBox="0 0 96 96" width="96">
