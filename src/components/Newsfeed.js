        ...
        {(newsfeed.length > 0) ? newsfeed.map((post, index) => (
          <div className="NewsfeedPost" key={post.postId}>
            ...
            <div className="post-btns">
              ...
              <svg onClick={() => { navigate(`/p/${post.postId}`); handleViewFullPost(index); }} className="comment" color="currentColor" fill="currentColor" height="24" viewBox="0 0 24 24" width="24">
