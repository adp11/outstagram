  ...
  return (
    <div className="NewsfeedPost">
      <div className="user-profile">
        <img className="user-avatar" src={`${window.location.origin}/images/logo.png`} alt="" />
        <span className="username bold medium">andrew.pham___</span>
      </div>
      <div className="post-picture">
        <img src={`${window.location.origin}/images/sample.png`} alt="" style={{ width: "100%", height: "auto" }} />
      </div>
      ...
      <div className="grey extrasmall" style={{ margin: "0 20px" }}>1 DAY AGO</div>
